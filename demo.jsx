...
import { AppBar, Card, CardTitle, CardText, Button, IconButton, Input, ProgressBar, Slider } from './react-toolbox';
...
export default class DemoComponent extends React.Component {
    render () {
        ...
        const state = { name: '', phone: '', email: '', hint: '', progress: 30, buffer: 50, slider1: 0, slider2: 5, slider3: 1 };
        return (
            <div>
                ...
                <Card style={{ width: '90%', margin: '0 5%' }}>
                    <CardText>
                        <span style={{ display: 'inline-block', fontSize: 32, textTransform: 'uppercase', textAlign: 'center', color: 'red' }}>
                            Following are some examples taken from the React-Toolbox, rendered fully on the server. <br/>
